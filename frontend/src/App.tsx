...
function App() {
  ...
  const shell = (content: ReactNode) => <div className="app"><Sidebar page={page} setPage={setPage} /><main className="main">{content}</main></div>;
